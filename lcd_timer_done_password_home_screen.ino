...
//lcd.setCursor(0,1);
lcd.setCursor(0,0);
lcd.print("WELCOME TO ANAMED SYSTEMS");
    // wait a bit:
delay(1000);
//lcd.print(current0_date);
  while(1) {
    ...
    if((adc_key_in<110 && adc_key_in>90)||(adc_key_in<260 && adc_key_in >240)||(adc_key_in>630 && adc_key_in <650))
      {break;   }
...
/*else if(adc_key_in>910 && k_1==0)
{   
    while(adc_key_in>910)
    { adc_key_in = analogRead(0);
      k_1=k_1+1;
      //Serial.println(k_1);
