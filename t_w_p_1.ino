...
else if((l==1 && adc_key_in>910)&&(x!=HIGH&&previous!=LOW  && millis()-time >debounce && l==1&&x_1!=LOW&&x_2!=LOW)&&(x_1!=HIGH &&previous_1!=LOW && millis()-time >debounce &&x!=LOW&&x_2!=LOW)&&(x_2!=HIGH &&previous_2!=LOW && millis()-time >debounce&&x_1!=LOW&&x!=LOW))
{
if(adc_key_in>910 && k_1==0)
{   
    while(1)
    { adc_key_in = analogRead(0);
      k_1=k_1+1;
      ...
      else if((x==HIGH &&previous==LOW && millis()-time >debounce&&x_1==LOW&&x_2==LOW)||(x_2==HIGH &&previous_2==LOW && millis()-time >debounce&&x_1==LOW&&x==LOW)||(x_1==HIGH &&previous_1==LOW && millis()-time >debounce &&x==LOW&&x_2==LOW))
        {
        k_1=0;
        l=l+1;
        adc_key_in=1000;
...
/*else if(adc_key_in>910 && k_1==0 &&quick==18)
{   
    while(1)
    { adc_key_in = analogRead(0);
      k_1=k_1+1;
