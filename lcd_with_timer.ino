...
{
  if(x_1==HIGH &&previous_1==LOW && millis()-time >debounce &&l==4&&x==LOW&&x_2==LOW)||(x==HIGH &&previous==LOW && millis()-time >debounce && l==4&&x_1==LOW&&x_2==LOW))
   {//int HH_1;
    //int exit_1=0;
    while (1)
       {  if(x==HIGH &&previous==LOW && millis()-time >debounce&&x_1==LOW&&x_2==LOW)  
                         {lcd.clear();
                         lcd.setCursor(0,0);
                         HH_1=HH_1+1;
                         lcd.print("Timer");
                         ...
                         adc_key_in=1000;
                         time = millis();}
          else if(x_1==HIGH &&previous_1==LOW && millis()-time >debounce&&x==LOW&&x_2==LOW)
                      {
                         lcd.clear();
                         lcd.setCursor(0,0);
                         HH_1=HH_1-1;
