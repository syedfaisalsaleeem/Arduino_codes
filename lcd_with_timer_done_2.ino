...
int mode(int,int,float,int,int,int,int,int,int,int,int);
...
int mode(int m_1,int def,float count,int count_1,int count_2,int count_3,int count_4,int count_5,int HH_1,int mm_1,int ss_1)
{ 
  if(m_1==1)
  { //lcd.clear(0,0);
    def=1;
